...
permet à plusieurs développeurs de collaborer. \`A partir du moment o\`u la taille de
...
\sqsrc pour g\'erer votre code durant votre \arelire{programmation
  journali\`ere}. % REVOIR dans PBE 'your software' simplement.
...
\emph{Voil\`a!} Vous venez simplement de créer le paquetage \MC nommé \pkg{Perfect}. 
