...
% relecture par Rene Mages (Sun, 1 May 2011)
...
\begin{enumerate}
  ...
  \item les déclarations des variables locales (\ie \ct{cr} et
    \ct{count}); 
  \item un nombre quelconque d'expressions séparées par des points; dans notre exemple, il y en a trois \aretirer{quatre}.
