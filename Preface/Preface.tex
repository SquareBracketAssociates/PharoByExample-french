...
un \emph{fork}\footnote{\arelire{Projet dérivé d'une version d'un logiciel pré-existant.}} de \squeak\cite{Inga97a}, 
...
\pharo est le système de référence de \arelire{Seaside: le \framework 
destiné au développement web.} % CHANGE
...
\arelire{Pour autant, les approches en \emph{tabula rasa} fonctionnent rarement.}
%\arevoir{Les approches en \emph{big bang} fonctionnent rarement.} 
% Rene : au lieu de big bang nous pourrions peut-être employer l'expression "tabula rasa" ou "table rase" 
\pharo encourage les changements évolutifs et
incrémentaux. Nous voulons être capable d'expérimenter via les
nouvelles fonctionalités et autres bibliothèques. Par \emph{évolution},
...
la correction de la première édition de la version originale %ajout
de ce livre. % REVOIR

\section*{Remerciements pour l'édition française}

L'édition française de ce livre a été réalisée par
l'équipe de traducteurs et de relecteurs suivante: \arelire{A VENIR.}
%% REVOIR
