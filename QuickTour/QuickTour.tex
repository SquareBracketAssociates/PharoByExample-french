...
\caption{Fichiers de \pharo de l'archive \pharooneclick{} vus par les systèmes Windows et \macosx. Les fichiers \emph{PBE.image} et \emph{PBE.changes} doivent être modifiables en écriture.}\figlabel{download}
\end{figure}
