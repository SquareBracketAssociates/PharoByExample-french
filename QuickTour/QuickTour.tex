...
\item La \emphind{machine virtuelle} (abrégée en VM pour
  ...
  avez par exemple l'icône de la machine virtuelle pour le système
...
%lourd: a revoir
déplacer, copier ou lier le fichier \emph{.source} correspondant,
...
fenêtre de travail, en train de se déplacer d'où vous l'aviez
abandonné.
...
Vous verrez tout autour une collection d'icônes colorées nommée
