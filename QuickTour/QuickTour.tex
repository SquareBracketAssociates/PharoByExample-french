...
% relecture: Rene Mages (Sat Jan 12 17:28:17 CET 2008)
% note de martial: revoir les index pour les termes liés à Morphic
% adaptation pour PBE - 28729
% relecture: Rene Mages (Thu Jan 8 11:22:22 CET 2010)
...
devez enregister sous un nouveau nom comme nous venons de le faire.
...
Les images sont très utiles mais nous considérons comme une pratique un peu 
...
ils contiennent des groupes de classes apparentées.
%\index{catégorie}
...
les objets 
%ajout
(tous dérivés de la classe Object, exception faite de ceux qui la surcharge).
...
votre nom sans espaces ou avec un point de séparation.
