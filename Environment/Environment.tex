...
celui présenté sur \figref{classbrowser}, vous pourriez avoir besoin 
...
sélecteur choisi. %CHANGE martial: la phrase trop lourde rene: ne fait pas mieux
...
% Rene propose de s'éloigner du texte anglais : s/la représentation imprimée/le nom/
...
\dothis{Après avoir \click{} sur le bouton \button{Over}, \clickz sur le 
...
technique majeure d'échange de code entre les utilisateurs
