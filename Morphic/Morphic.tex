...
\arelire{Ce code} crée un morph pour représenter la chaîne
...
Vous pouvez manipuler cet objet graphique \arelire{en
  \metaclickant{}}.
\index{world}
...
Dès lors, vous devez utiliser le halo Morphic en \arelire{\metaclickant}: les poignées \arelire{supérieures noire \grabHandle{}
...
classe \clsind{UIManager} offre \arelire{un grand nombre de} boîtes de
