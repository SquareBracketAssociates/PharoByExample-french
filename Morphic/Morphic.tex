...
%% Version: 13642
%% Last-Updated: Tue May  3 15:04:43 2011 (+0200)
%%           By: Martial Boniou
%%     Update #: 871
%% URL:
...
%% Relecture pour PharoBook: Rene Mages - Wed May  4 11:45:22 2011
...
boîte englobante, \mbox{\cad} une région rectangulaire occupant un
...
\ct{containsPoint:} retourne \ct{true} sont les mêmes points que ceux qui
...
%=================================================================
\section{Interaction et animation}
...
En outre, les morphs doivent être capables de répondre aux
interactions de l'utilisateur en changeant leur apparence et leur
...
%% REVOIR IMPORTANT
\tradalert{martial}{Faudrait-il mettre des méthodes \#clickButtonPressed et \#actClickButtonPressed dans Pharo?!}
...
et \mthind{MouseEvent}{yellowButtonPressed} \arelire{pour celle du
  \actclickbtn}~\footnote{NdT: Les termes \emph{``redButton''} et \emph{``yellowButton''} sont associés au code de couleurs utilisé historiquement dans \squeak pour décrire respectivement les commandes de \clickbtn{} et de \actclickbtn{} de la souris.}. % REVOIR martial: encore des vestiges de Squeak
...
notre croix avec les touches flêchées. Remarquez que lorsque la
...
classe \clsind{UIManager} qui offre un grand nombre de boîtes de
...
\ct{isStopped} est un booléen qui est \ct{true} si et seulement si
...
%ajout
\noindent{} Maintenant notre dé ``roule'' ou se fige quand nous cliquons dessus.
...
\noindent C'est tout ce dont nous avons besoin! 
