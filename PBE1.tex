...
% TODO
\newcommand{\pbecopydates}{2007, 2008, 2009\xspace} % dates de copyright
\newcommand{\pbecopypublish}{Décembre 2009\xspace} % date de parution de l'édition
\newcommand{\pbecopyidx}{Première\xspace} % indice de l'édition: première, ...
% \TODO
%=================================================================
% A4
...
a été publié en \pbecopypublish. Couverture par Samuel Morello.} % REVOIR
                                % ou bien Nierstrasz selon la version
                                % final ( % ATTENDRE )
%par \emph{Square Bracket Associates}, Suisse
% (\sba).
Vous pouvez vous procurer une
copie à l'adresse: \mbox{\ppe.}
\\[1cm]

Copyright \copyright~\pbecopydates{} by Andrew P.~Black, St\'ephane
