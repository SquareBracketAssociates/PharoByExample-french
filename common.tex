...
% revision: dpollet - 2010-05-16 14:05:40 +0200 (Sun, 16 May 2010)
% sync avec la version: 33691 - Tue Jun 22 11:51:51 CEST 2010
%=============================================================
...
\setboolean{deployment}{true}  % true pour enlever les couleurs et
                                % annotations de traduction
\newboolean{seaside-chapter}
\setboolean{seaside-chapter}{false} % officially no seaside but regex in french edition of PBE-1.0
\newcommand{\ifluluelse}[2]{\ifthenelse{\boolean{lulu}}{#1}{#2}}
\newcommand{\ifdeploy}[1]{\ifthenelse{\boolean{deployment}}{#1}{}}      % vf only
\newcommand{\ifseaside}[2]{\ifthenelse{\boolean{seaside-chapter}}{#1}{#2}}
%=============================================================
%:Names
...
\newcommand{\pharowebdownload}{\url{http://pharo-project.org/pharo-download}\xspace}
\newcommand{\pbe}{\url{http://PharoByExample.org}\xspace}
% pharo-french
\newcommand{\ppe}{\url{http://PharoByExample.org/fr}\xspace} % FINAL
\newcommand{\pharooneclick}{PBE-1.0-OneClick\xspace}         % FINAL
...
\newcommand{\dwdseaside}{\url{http://book.seaside.st/book}\xspace}
\newcommand{\bam}{\ct{BouncingAtomsMorph}\xspace}
%=============================================================
...
%=============================================================
%:Abbreviation macros
\newcommand{\ie}{\mbox{\emph{c-\`a-d.}}\xspace}
\newcommand{\cad}{\mbox{\emph{c-\`a-d.}}\xspace}
...
\newcommand{\clicke}{cliqué\xspace} % RED = click
\newcommand{\actclicke}{cliqué avec le bouton d'action\xspace} % YELLOW = action-click
\newcommand{\metaclicke}{meta-cliqué\xspace} % BLUE = meta-click
...
\newcommand{\sectionindex}[1]{\section{#1}\indexmain{#1}} % vf only
%=============================================================
%:Code macros
% some constants
...
%=============================================================
%:Footnotes in tabular environment (spécificité française)
\newcounter{notetab}            % cf. www.trustonme.net/didactels/248.html
...
\newcommand{\ntt}[1]{\addtocounter{footnote}{1}\footnotetext{#1}}
%=============================================================
%% [Squeak-fr]
...
\newcommand{\frmwk}{\emph{framework}\xspace}
\newname\framework{\ind{\frmwk}\footnote{Un \frmwk est un ensemble de
bibliothèques, d'outils et de conventions permettant le développement
d'applications.} (dit aussi ``cadre d'applications'')}[\frmwk]
\newcommand{\frameworks}{\emph{frameworks}\xspace}
\newcommand{\senders}{\emph{senders}\xspace}
\newcommand{\sennders}{\emph{se\underline{n}ders}\xspace}
...
\newcommand{\immplementors}{\emph{i\underline{m}plementors}\xspace}
...
\newcommand{\task}{\emph{task}\xspace} % les WATasks en Seaside
...
\newcommand{\expreg}{expression régulière\xspace}
\newcommand{\expregs}{expressions régulières\xspace}
\newcommand{\pattern}{\emph{pattern}\xspace}
%\newcommand{\patterns}{\emph{patterns}\xspace}
\newcommand{\pkgregex}{\pkg{Regex}}
\newcommand{\sitemap}{\emph{site map}\xspace}
\newcommand{\patmatch}{\emph{pattern matching}\xspace}
\newcommand{\regexmatch}{\emph{regex match}\xspace}
\newcommand{\regexmatches}{\emph{regex matches}\xspace}
\newcommand{\kleenestar}{fermeture de Kleene\xspace}
\newcommand{\escchar}{caractère d'échappement\xspace}
\newcommand{\pragma}{\emph{pragma}\xspace}
\newcommand{\pragmas}{\emph{pragmas}\xspace}
\newcommand{\Pragma}{\emph{Pragma}\xspace}
\newcommand{\Pragmas}{\emph{Pragmas}\xspace}
...
%% UNITÉS VARIABLES (nombres de classe...)
\newcommand{\drawOnImplNumber}{77\xspace} % nombre de méthodes
                                % #drawOn: (ne rien mettre si incertain)
...
\hyphenation{Bounc-ing-Atoms-Morph}
%=============================================================
