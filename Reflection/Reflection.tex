...
\st est un langage de programmation réflexif. En résumé, cela signifie que les programmes ont la possibilité d'agir sur leur propre exécution et structure.
...
Dans les prochaines sections, nous verrons comment exploiter notre connaissance des mécanisems d'exécution pour répondre à de telles questions.
