...
Supposons que nous voulons arrêter le programme seulement si le message \ct{add} est envoyé dans le contexte de \ct{OrderedCollectionTest>>>testAdd}.
...
\mbox{\ct{new},}
\mbox{\ct{new:},}
\arevoir{\mbox{\ct{x}} et \mbox{\ct{y}.}}
