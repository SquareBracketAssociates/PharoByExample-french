...
Les méthodes définissant une requête particulière peuvent être retrouvés à partir d'une classe. La classe \ct!SplitJoinTest! contient certaines méthodes de classes annotées avec \ct!<ignoreForCoverage>! :
