...
cet objet le message \ct{makeToc}, il parcourra les fichiers et
...
complémentaire~\footnote{NB: Dans \pharo,
  ...
  l'accent circonflexe dans les \expregs pour les
...
\noindent{} \arevoir{Les classes vides et universelles ne peuvent pas être définies.}
