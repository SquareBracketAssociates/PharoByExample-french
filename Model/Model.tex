...
Toutes les méthodes sont \subind{méthode}{publique}{}s~\footnote{En fait, presque toute.  En \pharo, des méthodes dont les sélecteurs commencent par
...
En cliquant sur le 
bouton \button{instance}, vous voyez la présentation de la classe \ct{Color}, \ie vous pouvez naviguer dans les méthodes qui sont exécutées quand les messages sont envoyés à une instance de
