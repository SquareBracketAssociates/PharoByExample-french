...
\noindent
Une autre différence importante est que \ct{String} est \arelire{modifiable
(nous disons alors que \ct{String} est mutable)},
...
%  flottants, fractions et entiers.
  ...
  \item les chaînes de \arelire{caractères sont mutables} mais les symboles ne le sont pas;
